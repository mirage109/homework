public class Main {
    public static void main(String[] args) {
        //превышение менее 10% от скоростного ограничени€ Ц не штрафуетс€

        //10% - менее 20%   от скоростного ограничени€ Ц 50 евро

        //20% - менее 30%   от скоростного ограничени€ Ц 150 евро не на автобане, и 200 на автобане

        //от 30% и выше  - 500евро плюс, если нарушение на автобане, лишение прав на 3 мес€ца.
        //–еализуйте программу, котора€ рассчитывает штраф и выводит соответствующее сообщение на экран.
